...
return ( <div className="setting-page setting-page-secure"> <CommonWindowHeader> <h2 className="setting-page__title">Безопасность</h2> </CommonWindowHeader>
  ...
  <div className="flex-1 min-h-0 w-full overflow-y-auto py-6 flex flex-col items-center gap-4">
    ...
    {/* Blacklist */}
    <div className="setting-page-secure__body bg-white"><SettingListItem
        title="Чёрный список"
