...
return ( <div className={`setting-page-secure__body ${bodyBg? 'p-4' : ''}`} style={{background:bodyBg? 'white': 'none'}}><div className={bodyBg? 'border-b border-gray' : ''}>{title && <h2 className="setting-page-secure__title">{title}</h2> }{headerContent && headerContent}</div>
